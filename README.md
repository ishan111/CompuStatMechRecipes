...
06-06-2017 UPDATE: MATLAB ISING MODEL TMMC CODE WAS INCLUDED tmmc implementation is for 1D only, for Magnetization and for Energy in seperate files and TMMC plotting scripts are done seperately
